...
def get_track_face_encodings(tracks, scores, args):
    ...
    # with open(args.videoName + "_tracks.pkl", "wb") as pickle_file:
    #     pickle.dump(tracks, pickle_file)
    # with open(args.videoName + "_scores.pkl", "wb") as pickle_file:
    ...
    progress_bar = tqdm_progress(total=total_frame_tracks, unit='tracks', dynamic_ncols=True)
    ...
    # with open(args.videoName + "_faces.pkl", "wb") as pickle_file:
