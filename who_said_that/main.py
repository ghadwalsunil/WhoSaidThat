...
run_timestamp = "AVA_AVD_MY_DATASET"
...
for video_file in video_list.VIDEO_FILES:
    ...
    preprocess = Preprocess(
        ...
        video_folder=video_list.VIDEO_FOLDER,
